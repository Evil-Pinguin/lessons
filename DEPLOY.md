...
> База уже создавалась раньше? **Запустите файл ещё раз** — добавится поле
> `contact` (обновление 2026-09, форма теперь из 3 полей: имя, контакт, тема),
> email станет необязательным. Ничего не сломается.
